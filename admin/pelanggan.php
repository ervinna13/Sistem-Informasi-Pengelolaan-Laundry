...
<body>
					...
					<div class="row align-items-center">
						<div class="col">
							<div class="mt-5">
								...
								<a href="tambah_pelanggan.php" class="btn btn-primary float-right veiwbutton"> <i class="fas fa-plus-circle"></i></a>
											...
											while ($row = mysqli_fetch_assoc($result)) {
												...
												echo
													...
													<div class="dropdown dropdown-action"> <a href="#"
														...
														<a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_asset" data-id="' . $row['id_member'] . '">
	...
	<script>
		$('#delete_asset').on('show.bs.modal', function (event) {
			...
			document.getElementById('deletememberId').value = id_member;
		});

		function deletemember() {
			var id_member = document.getElementById('deletememberId').value;
