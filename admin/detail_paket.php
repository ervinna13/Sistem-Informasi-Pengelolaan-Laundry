                            ...
                            <div class="card-body">
                                ...
                                <form method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="jenis" name="jenis" value=" <?= $paket['jenis']; ?>" readonly>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="estimasi" name="estimasi" value=" <?= $paket['estimasi']; ?>" readonly>
