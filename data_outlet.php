											...
											while ($row = mysqli_fetch_assoc($result)) {
												...
												echo
													...
													<div class="dropdown dropdown-action"> <a href="#"
														...
														<a class="dropdown-item" href="hapus_outlet.php?id=' . $row['id_outlet'] . '"><i class="fas fa-trash-alt m-r-5"></i> Delete</a> 
														</div>
													</div>
												</td>';
												echo '</tr>';
						...
						<div class="modal-body text-center"> <img src="assets/img/sent.png" alt="" width="50"
							...
							<div class="m-t-20"> <a href="#" class="btn btn-white" data-dismiss="modal">Close</a>
								<button type="button" class="btn btn-danger"
									onclick="deleteOutlet(<?= $row['id_outlet'] ?>)">Delete</button>
...
//         window.location.href = "hapus_outlet.php?id=" + id;
//     }
// }
	</script>
	<!-- <script>
